			...
			If $body <> "" Or $iden <> "" Then
				...
				Switch $body[$x]
					Case GetTranslated(620,1, "BOT") & " " & GetTranslated(620,14, "HELP")
						...
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,7,"BOT ADD n") & GetTranslated(638,17, " - add account number n to playing list")
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,8,"BOT REM n") & GetTranslated(638,18, " - remove account number n from playing list")
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,9,"BOT HIDE") & GetTranslated(638,19, " - hide android emulator")
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,10,"BOT ATKP 1/0") & GetTranslated(638,20, " - enable/disable attack plan")
						$txtHelp &= '\n'
