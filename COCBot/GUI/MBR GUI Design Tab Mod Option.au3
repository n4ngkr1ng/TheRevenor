...
;===================================================================================================================;
	...
	GUICtrlCreateGroup(GetTranslated(636,2, "Switch CoC Accounts"), $x - 20, $y - 20, 440, 90)
		$chkSwitchAcc = GUICtrlCreateCheckbox("Enable Switch Account", $x - 10, $y, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_CHECKED)
		$lbTotalCoCAcc = GUICtrlCreateLabel("Total CoC Accounts:", $x + 138, $y + 2, 130, 20)
		$txtTotalCoCAcc = GUICtrlCreateInput("0", $x + 240, $y - 1, 35, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetLimit(-1, 1)
			$txtTip = "Number of Google Accounts on emulator. Supporting maximum 8 Accounts."
			GUICtrlSetTip(-1,$txtTip)
		$lbActiveCoCAcc = GUICtrlCreateLabel("Active Accounts:", $x + 288, $y + 2, 130, 20)
		$txtActiveCoCAcc = GUICtrlCreateInput("0", $x + 373, $y - 1, 35, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetLimit(-1, 1)
			$txtTip = "Number of Google Accounts that you set for botting."
			GUICtrlSetTip(-1,$txtTip)
		$lbAccBottingOrder = GUICtrlCreateLabel("CoC Accounts botting order:", $x - 10, $y + 29, 135, 20)
		$txtAccBottingOrder = GUICtrlCreateInput("12345678", $x + 138, $y + 28, 70, 21,  BitOR($GUI_SS_DEFAULT_INPUT,$SS_LEFT, $ES_AUTOHSCROLL))
			...
			GUICtrlSetTip(-1,$txtTip)
		$lbProfileIdxOrder = GUICtrlCreateLabel("BOT Profile Indexs order:", $x + 215, $y + 29, 130, 20)
